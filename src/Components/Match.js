    ...
    return (
        <div className="indicator mx-4 my-6">
            ...
            <div style={{ borderRadius: "12px" }}
                ...
                <button className="btn btn-outline btn-sm btn-warning disabled:text-[gray]" disabled={creator === user?.displayName} onClick={() => navigate(`/${gameType}/friend/playing/` + _id)}>Join Game</button>
            </div>
        </div>
    );
};
